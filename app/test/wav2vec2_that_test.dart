...
void main() {
  // Trỏ `ort` vào bản ONNX Runtime của repo khi người chạy chưa tự đặt
  // ORT_DYLIB_PATH. Thiếu bước này thì trên máy Mac, lượt mở phiên đầu tiên
  // làm `ort` panic mà crate dựng với `panic = "abort"`, giết cả tiến trình
  // test — xem `chuanBiOnnxRuntime`.
